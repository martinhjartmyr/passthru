...
public extension GainChannel {

    enum CA {
        public static let globalScope = kAudioObjectPropertyScopeGlobal
        public static let inputScope = kAudioObjectPropertyScopeInput
        public static let outputScope = kAudioObjectPropertyScopeOutput
        public static let mainElement = kAudioObjectPropertyElementMain
        ...
        public static func outputDevices() -> [AudioObjectID] {
        ...
        public static func deviceName(_ id: AudioObjectID) -> String {
        ...
        @discardableResult
        public static func setDefaultOutput(_ id: AudioObjectID) -> OSStatus {
            var addr = address(kAudioHardwarePropertyDefaultOutputDevice)
            var dev = id
            let sys = AudioObjectID(kAudioObjectSystemObject)
        ...
        public static func deviceUID(_ id: AudioObjectID) -> String? {
        ...
        public static func device(matchingUID uid: String) -> AudioObjectID? {
            outputDevices().first { deviceUID($0) == uid }
        }

        // MARK: Scalar properties

        public static func nominalRate(_ id: AudioObjectID) -> Double {
        ...
        @discardableResult
        public static func setNominalRate(_ id: AudioObjectID, _ rate: Double) -> OSStatus {
            var addr = address(kAudioDevicePropertyNominalSampleRate)
            var r = rate
            return AudioObjectSetPropertyData(id, &addr, 0, nil, UInt32(MemoryLayout<Float64>.size), &r)
        }

        public static func bufferFrameSize(_ id: AudioObjectID) -> Int {
        ...
        public static func streamDescription(_ id: AudioObjectID, scope: AudioObjectPropertyScope) -> AudioStreamBasicDescription? {
        ...
        public static func formatLine(_ id: AudioObjectID, scope: AudioObjectPropertyScope) -> String {
        ...
        public static func shortFormatLine(_ id: AudioObjectID, scope: AudioObjectPropertyScope) -> String {
            guard let asbd = streamDescription(id, scope: scope) else { return "unknown" }
            let kind: String
        ...
        public static func volumeScalar(_ id: AudioObjectID, scope: AudioObjectPropertyScope) -> Float? {
        ...
        public static func volumeDecibels(_ id: AudioObjectID, scope: AudioObjectPropertyScope) -> Float? {
        ...
        public static func isMuted(_ id: AudioObjectID, scope: AudioObjectPropertyScope) -> Bool? {
        ...
        public static func addListener(_ objectID: AudioObjectID,
        ...
        public static func removeListener(_ objectID: AudioObjectID,
                                           _ selector: AudioObjectPropertySelector,
                                           scope: AudioObjectPropertyScope = kAudioObjectPropertyScopeGlobal,
        ...
        public static func bufferCount(_ list: UnsafeRawPointer) -> Int {
        ...
        public static func bufferArray(_ list: UnsafeRawPointer) -> UnsafePointer<AudioBuffer> {
        ...
        public static func channelCount(buffer: AudioBuffer) -> Int {
